        ...
        try {
            if (mensagemDeErro == null) 
            {
                if (id.isEmpty() || id.equals("0")) {
                    servico.incluir(nome, sobrenome, cpf, rg, nascimento, sexo, email, telefone, endereco, numero, bairro);
                } else {
                    servico.alterar(Integer.parseInt(id), nome, sobrenome, cpf, rg, nascimento, sexo, email, telefone, endereco, numero, bairro);
                }
