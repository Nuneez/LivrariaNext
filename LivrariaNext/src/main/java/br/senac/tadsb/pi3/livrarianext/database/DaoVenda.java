...
import br.senac.tadsb.pi3.livrarianext.models.Venda;
...
public class DaoVenda extends Dao<Venda> {
    ...
    public DaoVenda() throws SQLException, Exception {
        super(new ConnectionUtils());
    }    
    
    public DaoVenda(ConnectionUtils util) throws SQLException, Exception {
        super(util);
    }
